...
const TermsOfServicePage = () => (
  <div className="max-w-2xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
    ...
    <p className="mb-4">Welcome to easyByFar! By using our website and services, you agree to the following terms and conditions. Please read them carefully.</p>
    ...
    <p className="mb-4">All content on this site, including text, graphics, logos, and images, is the property of easyByFar or its licensors and is protected by copyright laws.</p>
    ...
    <p>If you have any questions about these Terms, please contact us at m4botdev@gmail.com.</p>
  </div>
);
